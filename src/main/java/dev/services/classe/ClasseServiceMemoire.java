...
public class ClasseServiceMemoire implements ClasseService {

	private List<Classe> classes = new ArrayList();

	/*
	 * public ClasseServiceMemoire(List<Classe> classes) { super(); this.classes
	 * = classes; }
	 */
