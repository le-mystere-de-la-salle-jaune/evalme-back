...
insert into stagiaire(nom, prenom, email, photo_url) values ('Abitbol', 'Georges', 'mondedemerde@clas.se', 'abitbol.jpg', 2);
insert into stagiaire(nom, prenom, email, photo_url) values ('Porc', 'Francis', 'dudeleesport@afes.fr', 'porc.jpg',3);
insert into stagiaire(nom, prenom, email, photo_url) values ('Mansoif', 'Gérard', 'gerard.mansoif@wanadoo.fr', 'mansoif.jpg',4);
