...
import dev.services.quizz.QuizzServiceMemoire;

// Sélection des classes de configuration Spring à utiliser lors du test
@ContextConfiguration(classes = { QuizzServiceMemoire.class })
// Configuration JUnit pour que Spring prenne la main sur le cycle de vie du
// test
@RunWith(SpringRunner.class)
public class QuizzServiceMemoireTest {

	@Autowired
	private QuizzServiceMemoire service;
