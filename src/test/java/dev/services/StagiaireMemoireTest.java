...
import dev.services.stagiaire.StagiaireServiceMemoire;

//Sélection des classes de configuration Spring à utiliser lors du test
@ContextConfiguration(classes = { StagiaireServiceMemoire.class })
// Configuration JUnit pour que Spring prenne la main sur le cycle de vie du
// test
@RunWith(SpringRunner.class)
public class StagiaireMemoireTest {

	@Autowired
	private StagiaireServiceMemoire service;
